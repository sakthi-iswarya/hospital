...
if(isset($_POST['Submit']))
{
  ...
  $date=$_POST['date'];
          ...
          $msg=mysqli_query($con,"insert into doctor(emp_name,emp_id,title,email,mobile,date) values('$name','$fid','$title','$email','$mobile','$date')");
  ...
  <section id="container" >
      ...
      <section id="main-content">
          <section class="wrapper">
            <h3><i class="fa fa-angle-right"></i> Add Doctor </h3>
        <div class="row">
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Doctor Name</label>
                              <div class="col-sm-10">
                              ...
                              <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Doctor Id</label>
                              <div class="col-sm-10">
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Join Date</label>
                              <div class="col-sm-10">
                          ...
                          <input type="submit" name="Submit" value="Add Doctor" class="btn btn-theme"></div>
                          </form>
                      </div>
                  </div>
              </div>
