...
if(isset($_POST['Submit']))
{
  ...
  $uid=intval($_GET['uid']);
$query=mysqli_query($con,"update doctor set emp_name='$name',emp_id='$fid',
 title='$title', email='$email', mobile='$contact', date='$date' where id='$uid'");
...
<html lang="en">
  ...
  <section id="container" >
      ...
      <?php $ret=mysqli_query($con,"select * from doctor where id='".$_GET['uid']."'");
	  while($row=mysqli_fetch_array($ret))
	  
	  {?>
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> <?php echo $row['emp_name'];?>'s Information</h3>
