  ...
  $allowTypes = array('jpg','png','jpeg','gif','pdf');
    if(in_array($fileType, $allowTypes)){
        ...
        if(move_uploaded_file($_FILES["file"]["tmp_name"], $targetFilePath)){
          $msg=mysqli_query($con,"insert into patient(pat_name,pat_id,issues,email,mobile,date,image) 
          values('$name','$fid','$issues','$email','$mobile','$date','".$fileName."')");
        }
                  ...
                  <div class="col-md-12">
                      <div class="content-panel">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="pat_name" value="" >
                              </div>
                          </div>
                              ...
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="pat_id" value="" >
                              </div>
                          </div>
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label" style="padding-left:40px;">Issues</label>
                              <div class="col-sm-10">
                                  <input type="text" class="form-control" name="issues" value="" >
                              </div>
                          </div>
                           <div class="form-group">
