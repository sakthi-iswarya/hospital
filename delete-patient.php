...
{
$adminid=$_GET['id'];
$msg=mysqli_query($con,"delete from patient where id='$adminid'");
if($msg)
{
  ...
  <section id="container" >
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
             <ul class="sidebar-menu" id="nav-accordion">       
                  ...
                  <li class="mt"><a href="add-users.php"> <i class="fa fa-file"></i><span>Add Users </span></a> </li><li class="mt"><a href="assign.php"> <i class="fa fa-file"></i><span>Assign Doctor</span></a> </li>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Patient Report</h3>
				<div class="row">
                          ...
                          <table class="table table-striped table-advance table-hover">
                              ...
                              <td><?php echo $cnt;?></td>
                                  ...
                                  <td>
                                     ...
                                     <a href="update-patient.php?uid=<?php echo $row['id'];?>"> 
