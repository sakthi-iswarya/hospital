...
if(isset($_POST['Submit']))
{
  ...
  $uid=intval($_GET['uid']);
$query=mysqli_query($con,"update user set f_name='$fname' ,l_name='$lname' ,
  email='$email' contact_no='$contactno' where id='$uid'");
...
<html lang="en">
  ...
  <section id="container" >
      ...
      <?php $ret=mysqli_query($con,"select * from user where id='".$_GET['uid']."'");
	  while($row=mysqli_fetch_array($ret))
	  
	  {?>
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> <?php echo $row['f_name'];?>'s Information</h3>
